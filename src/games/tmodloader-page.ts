...
class TModLoaderPage extends GamePage<TModLoaderPersistedSchema, TModLoaderPersistedObject> {
    ...
    private promptAdvancedUpdatePage = async (instances: TModLoaderPersistedObject[]) => {
    ...
    private freezeConfigs = (instance: TModLoaderPersistedObject) => {
        const content = [
        ...
        const configPath = `${instance.gameWorkingDirectoryPath}/systemgenerated.conf`
